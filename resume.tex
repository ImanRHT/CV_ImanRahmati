...
{\multilineCell
	{
        ...
        \hspace{5mm} \textbf{Supervisor}: Prof. A. Movaghar \href{https://scholar.google.com/citations?user=BXNelwwAAAAJ\&hl=en}{\small \faExternalLink}}
}
\vspace{-5mm}    
...
\hspace{-7mm}\textbf{Sub-Reviewer at 27th International Computer Conference}\hfill CSICC, 2022 \\
  ...
  \begin{itemize}
  	...
  	\href{https://github.com/ImanRHT/QECO_IEEEJournal/blob/main/QECO-submitted.pdf}{\small  \faExternalLink}
...
\begin{itemize}
	...
	\item \textbf{Dueling Double Deep Q-Networks (D3QN)} \hfill SUT, 2022\\
     Designed based on markov decision processes, and employed in distributed computation offloading decision-making \href{https://github.com/ImanRHT/QECO}{\faGithub} %\\Supervisor: Prof.  Ali Movaghar and Prof. Hamed Shah-Mansouri \href{https://scholar.google.com/citations?user=dcjIFccAAAAJ&hl=en&oi=ao}{\small \faExternalLink} 
	...
	Discrete Event Simulation and Performance Evaluation of queues with various service orders. %\href{https://github.com/ImanRHT/MM1K_Queue_Simulation}{\faGithub} Supervisor: Prof.  Ali Movaghar
